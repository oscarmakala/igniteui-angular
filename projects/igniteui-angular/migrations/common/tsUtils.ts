...
import * as ng from '@angular/language-service/language-service';
import { Tree } from '@angular-devkit/schematics';
// import { createLanguageServiceFromTypescript, LanguageService } from '@angular/language-service/language-service';
...
/**
 * Create an Angular language service
 * @param tsLsHost A TypeScript language service host
 * @param tsLS A TypeScript language service
 */
export function getNgLanguageService(tsLSHost: ts.LanguageServiceHost, tsLS: ts.LanguageService): ng.LanguageService {
    return ng.createLanguageServiceFromTypescript(tsLSHost, tsLS);
}

/**
 * Create an Angular language service host
 * @param tsLSHost A TypeScript language service host
 * @param tsLS A TypeScript language service
 */
export function getNgServiceHost(tsLSHost: ts.LanguageServiceHost, tsLS: ts.LanguageService): ng.TypeScriptServiceHost {
    return new ng.TypeScriptServiceHost(tsLSHost, tsLS);
}
...
export function toPath(string: string): string {
